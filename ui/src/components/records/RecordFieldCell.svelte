<script>
    ...
    import RelationLabel from "@/components/base/RelationLabel.svelte";
...
<td class="col-type-{field.type} col-field-{field.name}">
    ...
    {:else if field.type === "bool"}
        <span class="label" class:label-success={record[field.name]} class:label-danger={!record[field.name]}
            >{record[field.name] ? "True" : "False"}</span
        >
